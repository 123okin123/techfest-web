...
import {crew, max} from "../../helpers/crew";
    ...
    render() {
        return (
          <Container>
              ...
              <ImageGrid justifyContent="space-between" backAndWhite elements={max.map(e=>{return {title: e.name, description: e.role, imageURL: e.imageURL}})} imageWidth={'180px'} elementWidth={'450px'} elementHeight={'180px'} elementMargin={'20px 0px'}/>
              }
          </Container>
        )
    }

        ...
        <Row className="justify-content-center">
            <Col xs="12" lg="4" className="py-3">
                <FlexContainer id="usp-title-1" className="mb-4">
                    ...
                    <HeaderTitle  onMouseOut={(e) =>e.target.innerHTML = "THE TECHFEST COMPETITION"} onMouseOver={(e) =>e.target.innerHTML = "MORE_DISCIPLINES"}>THE HACKATHON CHALLENGE</HeaderTitle>
                    <Bracket right/>
                </FlexContainer>
            ...
            <Col xs="12" lg="4" className="py-3">
                <FlexContainer id="usp-title-3" className="mb-4">
                    ...
                    <HeaderTitle onMouseOut={(e) =>e.target.innerHTML = "UNTERNEHMERTUM LAUNCH PAD"} onMouseOver={(e) =>e.target.innerHTML = "MORE_IMPACT"}>A LAUNCH PAD FOR STARTUPS</HeaderTitle>
                    <Bracket right/>
                </FlexContainer>
                <ul className="list-style-x">
